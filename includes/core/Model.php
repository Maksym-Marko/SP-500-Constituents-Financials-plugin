...
class MXSAPC_Model
{
	...
	* Table name
	*/
	protected $table = MXSAPC_TABLE_SLUG;
	...
	*/
	public function mxsapc_get_row( $table = NULL, $wher_name, $wher_value )
	{
	...
	*/
	public function mxsapc_get_results( $table = false, $wher_name = NULL, $wher_value = 1 )
	{
